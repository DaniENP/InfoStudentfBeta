...
public class FragmentMaps extends SupportMapFragment implements OnMapReadyCallback, GoogleMap.OnInfoWindowClickListener, GoogleMap.OnPolylineClickListener {
    ...
    /**
     * Maps configuration Zoom activation, camera location, method where are added all markers for application (specifying titles and icons for each location added).
     * @param googleMap
     */
    @Override
